                        ...
                        <button
                            ...
                            className={`min-w-[64px] px-3 py-2 rounded-xl border text-sm transition-all
                                ${hora === horaSelecionada
                                    ? "border border-solid border-yellow-500 bg-yellow-50 text-yellow-700 font-medium"
                                    : "border border-solid border-gray-50 bg-gray-100 text-gray-700"
                                }
            ...
            <div className="relative mb-4">
                <div
                    ...
                    className={` group flex items-center justify-between w-full p-3 rounded-xl cursor-pointer transition-all bg-white border border-solid
                        ${showCalendar ? "border-[#CDA327]/50 shadow-[0_0_0_3px_rgba(205,163,39,0.15)]" : "border-gray-300"}
                    `}
                >
                    ...
                    ${showCalendar ? "text-[#CDA327]" : "text-gray-400"}
                `}
                        />
                        <span
                            className={`
                ...
                ${showCalendar ? "rotate-180 text-[#CDA327]" : "rotate-0"}
            `}
                    />
                </div>

                {showCalendar && (
                    <div className="absolute left-0 right-0 mt-2 z-20 rounded-2xl bg-white shadow-2xl animate-fadeIn border border-gray-200 flex justify-center">
